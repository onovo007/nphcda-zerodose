...
def _lang() -> str:
    """The response language ZARA should answer in (set in the sidebar). English by default."""
    ...
    if (cached is None or cached.get("hash") != h) and auto_on():
        with st.spinner("Interpreting..."):
            st.session_state[skey] = {"hash": h,
                                      "text": llm.interpret(cfg["key"], model, title, what, data, language=lang)}
